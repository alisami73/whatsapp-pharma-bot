  ...
  const mail = contactLeads.buildContactLeadMail(
    {
      ...
      lang: 'es',
      sourcePage: '/contact.html?lang=es',
    },
    {
      ip: '203.0.113.10',
      referer: 'https://blinkpremium.blinkpharmacie.ma/contact.html?lang=es',
...
test('contact lead Microsoft Graph payload preserves subject, HTML body, and recipients', () => {
  ...
  const mail = contactLeads.buildContactLeadMail(
    ...
    {
      ip: '203.0.113.10',
      referer: 'https://blinkpremium.blinkpharmacie.ma/contact.html',
      userAgent: 'Mozilla/5.0',
